...
class Ui_showwid(QWidget):
    ...
    def setupUi(self, showwid):
        ...
        self.pushButton_2.clicked.connect(self.show_hist_pic)
        self.pushButton_3.clicked.connect(self.show_pie_pic)
    ...
    def retranslateUi(self, showwid):
        ...
        self.comboBox.setItemText(3, _translate("showwid", "Co"))
        self.comboBox.setItemText(4, _translate("showwid", "O3"))
        self.comboBox.setItemText(5, _translate("showwid", "So2"))
        self.comboBox.setItemText(6, _translate("showwid", "No2"))
        self.pushButton.setText(_translate("showwid", "展示"))
        self.pushButton_2.setText(_translate("showwid", "展示"))
        self.rankbox.setItemText(0, _translate("showwid", "日期"))
        self.rankbox.setItemText(1, _translate("showwid", "AQI指数"))
        self.rankbox.setItemText(2, _translate("showwid", "当天AQI排名"))
        self.rankbox.setItemText(3, _translate("showwid", "PM2.5"))
        self.rankbox.setItemText(4, _translate("showwid", "PM10"))
        self.rankbox.setItemText(5, _translate("showwid", "So2"))
        self.rankbox.setItemText(6, _translate("showwid", "No2"))
        self.rankbox.setItemText(7, _translate("showwid", "Co"))
        self.rankbox.setItemText(8, _translate("showwid", "O3"))
    ...
    def show_list(self):
        ...
        items = query_all(city, start, end, type, sort)
        for obj in items:
